...
#Transfers YTD
```{r, transfers}
source("code/monthly_report/get_transfer_journals.R")

plot_trans

knitr::kable(all_transfers_ytd, format = "html", digits = 2, col.names = c("Decision", "N", "%")) %>% 
  footnote(general = "Final decision on manuscripts transferred in this calendar year.") %>% 
  kable_styling()
```
